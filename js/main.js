var seed = Math.floor(Math.random() * 6060);
var accent;
var complement;
var navTop;
var topColor = "#fff";
...
$(document).ready(function() {
  ...
  $.ajax({
    url: 'https://8ljmba2dzi.execute-api.us-east-1.amazonaws.com/prod/DynamoDBManager',
    type: 'POST',
    ...
    success: function(result) {
      console.log(result);
      $("#cover-heading").html(result['body']['Item']['tagline']);
      $("#opener").html(result['body']['Item']['description']);
    },
    error: function(XMLHttpRequest, textStatus, errorThrown) {
      console.log("err--" + XMLHttpRequest.status + " -- " + XMLHttpRequest.statusText);
    }
  });
...
//  }
  ...
  sponsorSeed1 = Math.floor(seed * random(seed + 1) + 10);
  sponsorSeed2 = Math.floor(seed * random(seed * 2 + 7) + 20);
  sponsorSeed3 = Math.floor(seed * random(seed * 3 + 9) + 30);
